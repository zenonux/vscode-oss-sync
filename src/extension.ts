...
import { initConfigCommand, uploadFileCommand, syncFolderCommand, copyAndUploadFileCommand, uploadFolderCommand, copyLinkCommand } from './commands/oss';
...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(registerCommand('vscode-oss-sync.copyLink', copyLinkCommand));
	context.subscriptions.push(registerCommand('vscode-oss-sync.copyAndUploadFile', copyAndUploadFileCommand));
